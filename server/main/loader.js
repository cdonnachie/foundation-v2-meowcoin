...
const Loader = function(logger, configMain) {
  ...
  this.handleConfigs = function() {
    ...
    if (fs.existsSync(normalizedPath + 'evrmore.js')) {
      config = require(normalizedPath + 'evrmore.js');
      ...
      throw new Error('Unable to find evrmore.js file. Read the installation/setup instructions');
    }
    return config;
  };
};
