...
const Manager = function(config, configMain) {
  ...
  this.handleShare = function(jobId, client, submission) {
    ...
    const hashDigest = Algorithms.meowpow.hash();
    ...
    const shareMultiplier = Algorithms.meowpow.multiplier;
    const shareDiff = Algorithms.meowpow.diff / Number(headerBigInt) * shareMultiplier;
    const blockDiffAdjusted = job.difficulty * Algorithms.meowpow.multiplier;
